...
const PersistentDrawerLeft = () => {
  ...
  // Dummy search handler, replace with actual implementation
  ...
  return (
    <Box sx={{ display: 'flex' }}>
      ...
      <AppBar position="fixed" open={open} sx={{ background: 'transparent' }}>
        <Toolbar sx={{ background: '#173246', display: 'flex', width: 'auto' }}>
          <IconButton
            color="inherit"
          ...
          <Typography variant="h6" noWrap component="div" sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
